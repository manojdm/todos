...
const Todo = () => {
  ...
  mutation UpdateTodo($id: ID!, $completed: Boolean!, $tomatoesConsumed: Int!) {
    updateTodo(id: $id, completed: $completed, tomatoesConsumed: $tomatoesConsumed) {
      id
      name
      completed
      description
            ...
            <>
              ...
              <div ref={timer} className="todo-timer hide">
                ...
                <div className="timer-actions">
                  ...
                  <div className="reset">
                      <i onClick={handleReset} className="fa-sharp fa-solid fa-arrow-rotate-left"></i>
                  </div>
                  <div className="stop">
                    <i onClick={(e) => handleMarkComplete(e, todo.id)} ref={stop} className="fa-solid fa-stop"></i>
                  </div>
                </div>
          ...
          <div className="todo-content">
            <div className="todo-details">
              ...
              <div className="tomatoes">
                <i className="fa-solid fa-apple-whole"></i>: {todo.completed ? todo.tomatoesConsumed : tomatoesConsumed}
              </div>
            </div>
